...
public class FairBillingTest {
    ...
    public void testTimeToSecondsValid() {
        assertEquals(0, FairBilling.timeToSeconds("00:00:00"));
        assertEquals(50523, FairBilling.timeToSeconds("14:02:03"));
        assertEquals(86399, FairBilling.timeToSeconds("23:59:59"));
    }

    @Test
    public void testTimeToSecondsInvalid() {
        assertEquals(-1, FairBilling.timeToSeconds("25:00:00"));
        assertEquals(-1, FairBilling.timeToSeconds("14:60:00"));
        assertEquals(-1, FairBilling.timeToSeconds("14:02:60"));
        assertEquals(-1, FairBilling.timeToSeconds("invalid"));
        assertEquals(-1, FairBilling.timeToSeconds("14:02"));
    }
    ...
    public void testParseLogFileValid() throws IOException {
        ...
        List<FairBilling.LogEntry> entries = FairBilling.parseLogFile(tempFile.getAbsolutePath());
    ...
    public void testProcessSessionsSimplePair() {
        ...
        Map<String, FairBilling.UserSession> sessions = FairBilling.processSessions(entries);
